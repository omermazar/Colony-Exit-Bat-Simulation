...
if isfield(AllParams.BatSonarParams,'ObsClusterFlag')
    fullConfVer = AllParams.BatSonarParams.ObsClusterFlag;
else
    fullConfVer = false;
end
...
if ~fullConfVer
    ...
    tempManueverStage = BatManueverDecision_FullConfusion_ver08Aug24( ...
        BATx.PreyFindsStruct(PulseNum) , BATx.ObsFindsStruct(PulseNum), ... % BATx.ObsInBeamStruct(CurrentPulseNum), ...
        ConspsLocStruct, BATx.BatVelocity(nTime),...
        PrevManCmdSrtruct, PulseNum, BATx, AllParams, Terrain, nTime, true);
...
plot(xMasked, yMasked, 'x', 'Linewidth', 1.5, 'MarkerSize', 9, 'Color', colStruct.masking, 'DisplayName', 'Jammed Obs')
