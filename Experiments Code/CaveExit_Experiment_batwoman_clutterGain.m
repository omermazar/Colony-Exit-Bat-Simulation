function [Table_FullExperiment ] = CaveExit_Experiment_batwoman_clutterGain()
...
% % Var3
ClutterGainDB = [-10, 10, 20]; % default 6
NumOfSetups3    = length(ClutterGainDB);
var3            = getname(ClutterGainDB);

%%% parameter for Saving DATA
SavePath   = '/home/omermazar/caveExit_Results'; %'D:\Dropbox\University\מחקר\experiments\caveExit\Results\';
SaveExpDir = '/'; % 'Sep2022\Run\17Oct\';
saveBatDATAflg = 0;

% The experiment
ExperimentName = 'CaveExit_PK_LCave_clutterGain';
% Nexp=0;
