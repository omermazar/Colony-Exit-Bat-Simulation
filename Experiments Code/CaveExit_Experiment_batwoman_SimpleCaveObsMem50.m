function [Table_FullExperiment ] = CaveExit_Experiment_batwoman_SimpleCaveObsMem50()
...
% % Var3
ObsMemorySize = 50 ;% [3, 5, 8, 10]; % default 6
...
% The experiment
ExperimentName = 'CaveExit_PK_SimpleCave_Mem50';
% Nexp=0;
