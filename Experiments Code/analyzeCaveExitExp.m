...
%%%%% for special Tests
% checkParams = {'TotalObstacleManuverPulses'}; % { 'obsDetectProb_1m', 'conspsDetectProb_1m', 'obsDetectProb_2m', 'conspsDetectProb_2m', 'obsDetectProb_3m', 'conspsDetectProb_3m',};
%%%
...
%                          xticks(0:1:max(xlim))
            ...
            if saveResFlg
                % final for save
                fileName = ['caveExit_New_ByLvl_', currParam];
...
if saveResFlg
    ...
    writetable(TableCaveExit, fullfile(savePath, 'TableCaveExit_1_noMask.txt'))
end
