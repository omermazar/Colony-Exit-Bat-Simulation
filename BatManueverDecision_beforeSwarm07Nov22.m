       ...
       %% NEW - swarm
        if NumberOfOtherBats > 0
            ...
            if BAT.Consps_FindsStruct(AnalyzedPulseNum).IsAnyPreyDetected
                ...
                %%% Channged 31Oct22
                BatsDistances = BAT.Consps_FindsStruct(AnalyzedPulseNum).Distances;
                BatsVecAngles = BAT.Consps_FindsStruct(AnalyzedPulseNum).Angles;
                TargetsID =  BAT.Consps_FindsStruct(AnalyzedPulseNum).DetectedPreyNum;
                BatsRelativeDirection = Struct2OtherBats.Bat2TargetRelativeAngle;
