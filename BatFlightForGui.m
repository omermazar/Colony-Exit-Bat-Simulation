...
deBugBatSonar    = false;
deBugBatManeuver = false;
deBugInt2Det     = false;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
disp('OJT Version Confusion and Clustering with New Maneubers update 18Aug24')
NofInputs = nargin;
                   ...
                   try
                        ...
                        if ~deBugBatManeuver
                            if AllParams.BatSonarParams.ObsClusterFlag
                                %%%% for Cluster Use the FullVersion
                                [BAT(BatNum).ManueverCmdStruct(CurrPulseNum+1), BAT(BatNum).ObsInMemory(CurrPulseNum+1)] = BatManueverDecision_FullConfusion_ver08Aug24( ...
