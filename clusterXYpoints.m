...
%
%% Code
function [clustersCentroids,clustersGeoMedians,clustersXY] = clusterXYpoints(XY,maxdist,minClusterSize,method,mergeflag)
...
% Pairwise distances
% XY = importdata(inputfile); % read X and Y
...
% % 
% % for k = 1:8
% %     plot(clustersXY{k}(:,1), clustersXY{k}(:,2), '*', 'MarkerSize', 9)
% % end