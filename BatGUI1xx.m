function varargout = BatGUI1xx(varargin)
% BATGUI1XX MATLAB code for BatGUI1xx.fig
%      BATGUI1XX, by itself, creates a new BATGUI1XX or raises the existing
%      singleton*.
%
%      H = BATGUI1XX returns the handle to a new BATGUI1XX or the handle to
%      the existing singleton*.
%
%      BATGUI1XX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BATGUI1XX.M with the given input arguments.
%
%      BATGUI1XX('Property','Value',...) creates a new BATGUI1XX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BatGUI1xx_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BatGUI1xx_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BatGUI1xx

% Last Modified by GUIDE v2.5 30-Jun-2022 16:28:11
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @BatGUI1xx_OpeningFcn, ...
                   'gui_OutputFcn',  @BatGUI1xx_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BatGUI1xx is made visible.
function BatGUI1xx_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BatGUI1xx (see VARARGIN)
...
% Choose default command line output for BatGUI1xx
...
function varargout = BatGUI1xx_OutputFcn(hObject, eventdata, handles) 
...
MyBatAnimation(handles.DataToAnalyze, handles.DataToPlot, handles.SaveAminationFlag, handles.Terrain, handles.AnimationTimeRate);
